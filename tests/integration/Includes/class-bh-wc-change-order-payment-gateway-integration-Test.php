<?php
/**
 * Tests for BH_WC_Change_Order_Payment_Gateway main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WC_Change_Order_Payment_Gateway_Integration_Test extends \Codeception\TestCase\WPTestCase {

	public function hooks() {
		$hooks = array(
			array( 'init', I18n::class, 'load_plugin_textdomain' ),
			array( 'admin_enqueue_scripts', Admin_Order_UI::class, 'enqueue_styles' ),
			array( 'admin_enqueue_scripts', Admin_Order_UI::class, 'enqueue_scripts' ),
		);
		return $hooks;
	}
